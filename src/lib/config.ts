 ...
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * Project: Complete Workflow Test
 * Type: game
 * Category: game
 * 
...
export const PROJECT = {
  ...
  version: '1.0.0',
  license: 'GPL-3.0',
  url: 'https://complete-workflow-test.minidev.app',
  repository: 'https://github.com/MiniDevPlatform/complete-workflow-test',
} as const;
...
export const FEATURES = {
  ...
  // Campaign
  campaign: { enabled: false, levels: [], achievements: [], saveProgress: true, saveKey: 'complete-workflow-test_progress' },
